...
| <br>**INFORMATION SYSTEM ANALYSIS AND DESIGN** | <br>Project-Teamwork Based Learning: A Sales Management System For online Vegtable Store | This project is my academic project,using Figma, Stitch, StartUML, and Draw.io tools and working in a team to do this big homework from analyze business requirements, design use case diagram, DFDs - BPMN, ERD, and Prototype. | <br>[Click here to Find out](https://github.com/TrangDataforlife/Information_Systems_Analysis_and_Design) |
